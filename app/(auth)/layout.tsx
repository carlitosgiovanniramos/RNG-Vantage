  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-6xl items-center gap-8 px-4 py-8 lg:grid-cols-[1fr_minmax(360px,460px)] lg:px-8">
        <aside className="hidden h-full flex-col justify-between rounded-[2rem] border border-border/60 bg-background/80 p-8 shadow-2xl backdrop-blur lg:flex">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h1 className="max-w-xl text-5xl font-black tracking-tight text-foreground">
                Autenticación clara para clientes y administradores.
              </h1>
              <p className="max-w-lg text-base leading-7 text-muted-foreground">
                Ingresa con tu cuenta para continuar al catálogo o al panel de
                control según tu rol.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-3 text-sm text-muted-foreground">
            <div className="flex items-start gap-3 rounded-2xl border border-border/70 bg-background/80 p-4">
              ...
              <p className="leading-6">
                Redirección automática por rol para mantener separado el acceso
                de clientes y administración.
              </p>
            </div>
            <div className="flex items-start gap-3 rounded-2xl border border-border/70 bg-background/80 p-4">
              <div className="mt-0.5 rounded-full bg-primary/10 p-2 text-primary">
              ...
              <p className="leading-6">
                Registro con consentimiento LOPDP y creación de perfil
